...
function inicio()
{
    ...
    fondo.imagen = new Image(); /* objeto propio de js que me permite crear imagenes*/
    fondo.imagen.src = fondo.imagenURL;
    fondo.imagen.onload = confirmarFondo; /* No se ponen los parentesis ya que la funcion se llama cuando cargue la img*/
